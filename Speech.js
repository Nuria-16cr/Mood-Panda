...
function checkCommands(phrase) {
 ...
 if (/\b(hello|hi|hey)\b/.test(phrase)) {
  ...
  } else if (/(i love you|you're cute|you're awesome)/.test(phrase)) {
    ...
    if (lastCommand !== "smart" || now - lastCommandTime > cooldown) {
      speakResponse("I know 7 words and a joke about pandas. Pretty smart, huh?");
      lastCommand = "smart";
      lastCommandTime = now;
    }
